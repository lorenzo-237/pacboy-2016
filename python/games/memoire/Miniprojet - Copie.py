...
Le premier correspond à la première colonne de la grille et ainsi de suite
chaque case a un indice [i] , [0] = 1ere case , [1] = 2eme case , ...
"""
def grille():
    global prem_colonne,deux_colonne,trois_colonne,quat_colonne
    # ce sont des dictionnaires on peut ainsi donner un indice à une variable
...
def fin():
    if L==[[" "," "," "," "],[" "," "," "," "],[" "," "," "," "],[" "," "," "," "]]:
        showinfo("FIN DE PARTIE","Partie terminée ! BRAVO")
